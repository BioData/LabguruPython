...
def main():
    ...
    #     print(exp.id)
    #
    # print(lab.get_experiment(experiment_id='586'))
    # lab.add_experiment_procedure(experiment_id='1', name='Tran add section')
    #
    # print(lab.get_experiment(experiment_id='1'))

    # section
    # print(lab.add_experiment_procedure(experiment_id=817, name='test1'))
    # print(lab.find_experiment_procedure(name='test1')[0].id)
    # print(lab.get_experiment_procedure(section_id=5514))
    # print(lab.update_experiment_procedure(section_id=5514, name='new name'))
    # print(lab.list_experiment_procedures(experiment_id=817, page_num=1)[0].name)
    ...
    # print(lab.get_element_by_type(experiment_id=586, element_type='plate')[0])
    # print(lab.get_element_by_type(experiment_id=586, element_type='form')[1].description)
    # print(lab.get_element_by_type(experiment_id=804, element_type='plate')[0].name)
    # print(json.loads(lab.get_element_by_type(experiment_id=804, element_type='plate')[1].data)['wells'])
    # print(json.loads(lab.get_element_by_type(experiment_id=804, element_type='samples')[0].data).get('samples'))

    # print(lab.get_element_by_type(experiment_id=804, element_type='plate')[1].get_data())
    # print(lab.get_element_by_type(experiment_id=804, element_type='samples')[0].get_data())
    # print(lab.get_element_by_type(experiment_id=806, element_type='form')[1])
    # print(lab.add_element(section_id=5478, data=None, element_type='steps'))
    # print(lab.get_element(8034))

    # item
    # print(lab.add_item(name='test_lib', item_type='cell_lines'))
    # print(lab.get_item(item_id=329, item_type='cell_lines'))
    # print(lab.update_item(item_id=329, item_type='cell_lines', name='new name'))
    print(lab.list_item(item_type='cell_lines', page_num=1)[1].name)
    # print(lab.list_generic_item(item_type='services', page_num=1)[1].name)
    ...
    # # print(lab.find_stock(stock_name='test_2')[0].id)
    # print(lab.update_stock(stock_id=966, volume=5))

    # sample_element = lab.get_element_by_type(experiment_id=811, element_type='samples')[0]
    ...
    # steps_element = lab.get_element_by_type(experiment_id=812, element_type='steps')[0]
