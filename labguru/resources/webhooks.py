# labguru/resources/webhooks.py
from labguru.resources.base import BaseResource


class WebhooksResource(BaseResource):
    """Webhooks. list/get/create/update; the API has no delete endpoint. A
    GET /api/v1/webhooks/list endpoint also exists and is not modeled here.
    """
