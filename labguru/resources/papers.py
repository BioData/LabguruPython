# labguru/resources/papers.py
from labguru.resources.base import BaseResource


class PapersResource(BaseResource):
    """Papers / references. list/get/create/update; the API has no delete endpoint."""

    resource_name = "papers"
    item_key = "item"
